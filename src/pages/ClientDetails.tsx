...
import { Calendar, Clock, Play, Plus, Target, ArrowLeft, Settings, Trash2, Timer, Edit, Copy, User, Search, AlertCircle, XCircle, Ban, MapPin, Upload, ChevronLeft, ChevronRight, CornerDownRight, MoreVertical } from "lucide-react";
import { WeeklyFrequencyCalendar } from "@/components/workout/weekly-frequency-calendar";
  ...
  return <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="space-y-6">
          {/* Client Stats */}
          <WeeklyFrequencyCalendar workouts={allClientWorkouts} />
              ...
              return <div key={workout.id} className="relative">
                    ...
                    setDeletingWorkout(workout);
                         ...
                         {workout.canceled_at ? <div className="px-3 py-1.5 bg-destructive/10 text-destructive text-sm font-medium rounded-md flex items-center gap-2">
                             ...
                             Completed
                           </div> : progress > 0 ? <div className="px-3 py-1.5 bg-warning/10 text-warning text-sm font-medium rounded-md flex items-center gap-2">
                            ...
                            >
                              ...
                              <div className="flex items-center gap-1 shrink-0">
                                ...
                                {child.canceled_at ? (
                                  ...
                                  <div className="px-2 py-1 bg-warning/10 text-warning text-xs font-medium rounded-md flex items-center gap-1">
                                    <Play className="h-3 w-3" />
                                    In Progress
                                  </div>
                                ) : (
